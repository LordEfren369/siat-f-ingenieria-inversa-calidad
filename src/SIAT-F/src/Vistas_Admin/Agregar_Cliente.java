...
public class Agregar_Cliente extends javax.swing.JFrame {
    ...
    private void jBAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarActionPerformed
        if (jTFNombreCliente.getText().trim().isEmpty() //que no deje ningun campo vacio
        ...
        if (new OAD_Cliente().agregarCliente(c)) {
            ...
            limpiarCampos();
            int siguienteID = new OAD_Cliente().obtenerSiguienteID(); //Se manda a llamar el OAD para obtener el sigueinte ID
            jTFId.setText(String.valueOf(siguienteID)); //y que se actualice en el text field de ID automaticamente despues de agregar un cliente
        } else {
