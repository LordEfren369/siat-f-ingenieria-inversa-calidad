...
import static Vistas_Admin.Clientes.mt;
import java.util.List;
import javax.swing.table.DefaultTableModel;

public class Clientes_Vendedor extends javax.swing.JFrame {

    public Clientes_Vendedor() {
        initComponents();
        
        String ids[] = {"Id", "Nombre Cliente", "Negocio", "Ciudad", "Calle", "Colonia", "Número", "Telefono"};
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1215, 787));
    ...
    private void jTFBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFBuscarKeyReleased
        ...
        List<Cliente> lista = new OAD_Cliente().buscarClientes(texto);
